...
class TicketTableMap extends TableMap
{
     ...
     */
    const COL_TITLE = 'ticket.title';

    /**
     * the column name for the component field
     */
    const COL_COMPONENT = 'ticket.component';

    /**
     * the column name for the short_description field
     */
    const COL_SHORT_DESCRIPTION = 'ticket.short_description';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Component', 'ShortDescription', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'component', 'shortDescription', ),
        self::TYPE_COLNAME       => array(TicketTableMap::COL_ID, TicketTableMap::COL_TITLE, TicketTableMap::COL_COMPONENT, TicketTableMap::COL_SHORT_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'component', 'short_description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Component' => 2, 'ShortDescription' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'component' => 2, 'shortDescription' => 3, ),
        self::TYPE_COLNAME       => array(TicketTableMap::COL_ID => 0, TicketTableMap::COL_TITLE => 1, TicketTableMap::COL_COMPONENT => 2, TicketTableMap::COL_SHORT_DESCRIPTION => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'component' => 2, 'short_description' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('component', 'Component', 'VARCHAR', true, 255, null);
        $this->addColumn('short_description', 'ShortDescription', 'VARCHAR', true, 255, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TicketTableMap::COL_TITLE);
            $criteria->addSelectColumn(TicketTableMap::COL_COMPONENT);
            $criteria->addSelectColumn(TicketTableMap::COL_SHORT_DESCRIPTION);
        } else {
